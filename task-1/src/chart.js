...
export function createChart(container, data, isActive) {
  ...
  const chart = new Chart(ctx, {
    ...
    options: {
        ...
        /**
         * Поскольку в данных фигурируют только положительные числа, максимальный "0" был очевидной ошибкой.
         * Однако я всё равно начал с сравнения с рабочим конфигом из документации.
         */
